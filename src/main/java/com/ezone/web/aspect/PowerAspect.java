...
import com.ezone.web.domain.SysMenus;
import com.ezone.web.domain.UserInfo;
import com.ezone.web.schema.MenuSchema;
...
public class PowerAspect {
	...
	private static Object printTimeOut(Method method) {
		...
		if (responseBody == null) {
			return "redirect:"+RequestUtil.getRequest().getScheme()+":"+RequestUtil.loadBasePath(RequestUtil.getRequest())+"admin/login."+RequestUtil.getRequest().getSession().getAttribute("defSuffix");
		}
