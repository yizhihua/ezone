			...
			try {
				...
				try {
					...
					try{
						...
						setProperties(field, "fieldAccessor.isReadOnly", true);
						setProperties(field, "fieldAccessor.isFinal", true);
						setProperties(field, "overrideFieldAccessor.isReadOnly", true);
						setProperties(field, "overrideFieldAccessor.isFinal", true);
					}
				}catch (Exception e) {
					PrintException.printException(logger, e);
				}
